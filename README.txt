...
2. "tov_rad_eulerian2" is a modification of (1) and has the added utility of reading a tabulated EOS. (Presently, this code is crashing upon choosing the tabulated EOS.)
...
6. "tov_rad_interpol" is an extension of (3) to use tabulated EOS. (presently running indefinitely for tabulated EOS)
